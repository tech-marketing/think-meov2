...
CREATE POLICY IF NOT EXISTS "Users can delete briefings they created or admin/collab"
...
CREATE POLICY IF NOT EXISTS "Admins and collaborators can delete company materials"
ON public.materials
FOR DELETE
USING (
  company_id = get_current_user_company_id() AND
...
CREATE POLICY IF NOT EXISTS "Authors, material creators, admins and collaborators can delete comments"
ON public.comments
FOR DELETE
USING (
